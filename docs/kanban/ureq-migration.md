...
## Narrative
- 2026-06-16: Done. Shipped in commits 4fa3d90 (perf: replace reqwest with ureq 3 + native-tls) and 1eb1a8c (fix(http): explicitly set TlsProvider::NativeTls). Released in v0.3.0.
